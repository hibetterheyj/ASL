...
if __name__ == "__main__":
    ...
    # download scannet model using
    # python download-scannet.py --id scene0000_00 --type _vh_clean.ply -o ./scan_viz
    pcd = o3d.io.read_point_cloud("./scans/scene0000_00/scene0000_00_vh_clean.ply")
