...
# from lightning_new import Network
# from lightning_deeplab import DeepLabNetwork
...
def train_task(
  ...
  if skip:
    ...
    # lighting 1.6.0
    _ = trainer.fit(
      model=model, train_dataloaders=train_dataloader, val_dataloaders=val_dataloaders
    )
